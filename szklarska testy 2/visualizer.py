...
class Visualizer:
  def __init__(self):
    ...
    # do wizualizacji normal3.txt z proby 2 - pierwsze
    ...
    #szklarska pomiary 29.12.15 - nody trojkat (do weryfikacji)
    #             10   11     12          13      14        15       16        17         18
    #self.nodeX = [0.,6400.0 , 8967.0,  11456.0, 15081.,  17109.0,  19246.,  21163.,  23534.]
    #self.nodeY = [1000, 350., 550,       250,    600.,    230.,    785.,   0.5,    600.0 ]

    #szklarska pomiary 29.12.15 - nody bramki krotkie
    #             10     11     12        13      14        15       16        17         18
    #self.nodeX = [0.,  6400.0 , 6400.0,  12322.0, 12322.,  27262.0,  27262.,  34862.,  34862.]
    #self.nodeY = [1000, 300.,  800,       200,    800.,    200.,    800.,   300,    900.0 ]

    #szklarska pomiary 29.12.15 - nody bramki dlugie
    #             10     11     12        13      14        15       16        17         18
    self.nodeX = [0.,  6400.0 , 6400.0,  16470.0, 16470.,  27262.0,  27262.,  38012.,  38012.]
    self.nodeY = [1000, 300.,  800,       200,    800.,    200.,    800.,   300,    900.0 ]


    # self.nodeX = [0, 1600, 1600+1800, 1600+1800+1600, 1600+1800+1600+2000]
    # self.nodeY = [0, 350, 0, 350, 0]
  ...
  def node_action(self, nodes, test=False):
    if test:
      ...
      L = [4218,5041,1060,2198,5670,9332,14473,19432,21743]
        ...
        L = []
        for n in nodes:
          if n.a_counter < 30 and len(n.filtered_history) > 0:
  ...
  def compute_positions(self, tab, multi=1):
    ...
    for n in range(0, len(L)):
      txt = plt.text(self.nodeX[n]-80, self.nodeY[n]+80, "{}:{}".format(L[n],n), fontdict=font_node)
